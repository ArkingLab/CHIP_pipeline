...
$annovarpath/table_annovar.pl fin_df_Genome.input.txt $annovarpath/humandb/ -buildver hg38 -out Out -remove -protocol refGene,gnomad211_exome -operation g,f -nastring . -csvout -polish
